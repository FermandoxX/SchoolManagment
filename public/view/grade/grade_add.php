      ...
      <div class="col-xl-4">
        <div class="card">
          <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
            ...
            <h6><?php echo isset($subjectData[0]->class_name) ? "Class: ". $subjectData[0]->class_name : "" ?></h6>
            <h6><?php echo isset($subjectData[0]->name) ? "Teacher: ". $subjectData[0]->name." ".$subjectData[0]->surename : ""?></h6>
        ...
        <div class="card-body pt-3">
          ...
          <ul class="nav nav-tabs nav-tabs-bordered">
            ...
            <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
              ...
              <!-- Profile Edit Form -->
              <form action="/grade/insert<?php echo isset($data['student_id'],$data['subject_id']) ? '?student_id='.$data['student_id'].'&subject_id='.$data['subject_id'] : '' ?>" method="post" enctype="multipart/form-data">
